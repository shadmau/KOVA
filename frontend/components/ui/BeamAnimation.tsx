...
export function BeamAnimation() {
  ...
  return (
    <div
      className="relative flex h-[200px] w-full items-center justify-center overflow-hidden  border-none bg-background p-10 "
      ref={containerRef}
    >
      <div className="flex flex-col w-[900px] max-h-[100px] items-stretch justify-between gap-10">
